...
function populateBodyMenu(){
    alert("done bro");
    clear("wrapper");
    document.getElementById('wrapper').innerHTML='<iframe style="padding:10px; height: 450px; border: none" frameBorder="0" src="http://studmenuweb.herokuapp.com/menu/Taj"></iframe>';  
}
