...
function populateBodyTables(){
    ...
    var datatogive={"restaurant":restaurant,"noOfTables":noOfTables};   
     ...
     for(var tableNo=0;tableNo<noOfTables;tableNo++){
       ...
       card.innerHTML+='<iframe frameBorder="0" src="http://studmenuweb.herokuapp.com/groupcart/%7B%22restaurant%22:%22CAD%22,%22tableno%22:%22'+tableNo+'%22,%22identity%22:%22manager%22%7D"></iframe>';
...
function populateBodyMenu(){
    fetch('/populatedashboardmenuitems/CAD') // Call the fetch function passing the url of the API as a parameter
...
function populateBodyMenuForm(data){
    ...
    for(var category1index=0;category1index<category1list.length;category1index++){ 
        ...
        htmlstring=handleFromCategory2(category0item,category0datajson,category1list,category1item,category1datajson,category2list,htmlstring);
   }}
