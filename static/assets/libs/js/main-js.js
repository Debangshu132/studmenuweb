...
function populateBodyTables(){
    ...
    var datatogive={"restaurant":restaurant,"noOfTables":noOfTables};   
     ...
     for(var tableNo=0;tableNo<noOfTables;tableNo++){
       ...
       card.innerHTML+='<iframe frameBorder="0" src="http://studmenuweb.herokuapp.com/groupcart/%7B%22restaurant%22:'+restaurant+',%22tableno%22:%22'+tableNo+'%22,%22identity%22:%22manager%22%7D"></iframe>';
